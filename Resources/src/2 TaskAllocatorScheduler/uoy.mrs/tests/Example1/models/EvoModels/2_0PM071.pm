...
const int r1_travDist = 16; //l1->room5->room5->room5->room3->room3
...
module r1
  ...
  //r1_order=1: task at4_notify_3
  //r1_order=2: task at3_sanit_5
  //r1_order=3: task at2_floor_4
  //r1_order=4: task at3_sanit_2
  //r1_order=5: task at2_floor_1
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & (r1_time+ r1at4_notify_3Time + 9 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=2) & (r1_time'= r1_time+ r1at4_notify_3Time + 9) & (at4_notify_3'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at4_notify_3Time + 9) & (at4_notify_3'=1);
  [ ] r1_order=2 & r1_fail=0 & at4_notify_3=1 & (r1_time+ r1at3_sanit_5Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_5Time + 0) & (at3_sanit_5'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_5Time + 0) & (at3_sanit_5'=1);
  ...
  [ ] r1_order=5 & r1_fail=0 & at3_sanit_2=1 & at4_notify_0=1 & (r1_time+ r1at2_floor_1Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=6) & (r1_time'= r1_time+ r1at2_floor_1Time + 0) & (at2_floor_1'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at2_floor_1Time + 0) & (at2_floor_1'=1);
