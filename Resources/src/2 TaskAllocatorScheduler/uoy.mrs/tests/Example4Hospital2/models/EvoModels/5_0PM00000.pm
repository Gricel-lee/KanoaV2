...
formula done = (r5_order=5 & r4_order=6 & r1_order=9 & r2_order=2 & r3_order=3);

// failure
formula fail = (r5_fail=0 & r4_fail=0 & r1_fail=0 & r2_fail=0 & r3_fail=0 );
...
const int r1_travDist = 12; //l7->room2->room2->room3->room3->room4->room4->room5->room5
const int r2_travDist = 2; //l8->room3
const int r3_travDist = 10; //l9->room4->room5
...
module r1
  ...
  [ ] r1_order=2 & r1_fail=0 & at4_notify_2=1 & r1_time>=r4_time & (r1_time+ r1at3_sanit_4Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_4Time + 0) & (at3_sanit_4'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_4Time + 0) & (at3_sanit_4'=1);
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r1_time+ r1at2_floor_6Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1);
  [ ] r1_order=4 & r1_fail=0 & at4_notify_5=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_7Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  ...
  [ ] r1_order=6 & r1_fail=0 & at4_notify_8=1 & r1_time>=r3_time & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
  ...
  [ ] r1_order=8 & r1_fail=0 & at4_notify_11=1 & r1_time>=r3_time & (r1_time+ r1at3_sanit_13Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=9) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=9) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1);
...
module r3
  ...
  //r3_order=1: task at4_notify_8
  //r3_order=2: task at4_notify_11
  r3_order: [0..3] init 0; // execution order
  ...
  // do sequence of tasks
  [ ] r3_order=1 & r3_fail=0 & (r3_time+ r3at4_notify_8Time + 8 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=2) & (r3_time'= r3_time+ r3at4_notify_8Time + 8) & (at4_notify_8'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=2) & (r3_time'= r3_time+ r3at4_notify_8Time + 8) & (at4_notify_8'=1);
  [ ] r3_order=2 & r3_fail=0 & (r3_time+ r3at4_notify_11Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=3) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=3) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1);

  // failure and recovery
  [ ] r3_fail=1 -> (r3_fail'=0); // fail
  [r3idle] r3_order!=3 & r3_fail=0 & (r3_time+1<=TT) -> (r3_time'=r3_time+1); // idle
endmodule
