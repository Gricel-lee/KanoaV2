...
module r2
  ...
  [ ] r2_order=11 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r2_time+ r2at2_floor_12Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=12) & (r2_time'= r2_time+ r2at2_floor_12Time + 2) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=12) & (r2_time'= r2_time+ r2at2_floor_12Time + 2) & (at2_floor_12'=1);
