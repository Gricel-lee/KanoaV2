...
formula done = (r5_order=6 & r4_order=6 & r2_order=4 & r1_order=8);
...
const int r2_travDist = 8; //l8->room2->room3->room3
...
module r2
  ...
  [ ] r2_order=2 & r2_fail=0 & (r2_time+ r2at4_notify_5Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_5Time + 2) & (at4_notify_5'=1);
  [ ] r2_order=3 & r2_fail=0 & at4_notify_5=1 & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
...
module r1
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & at4_notify_2=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_4Time + 6 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1);
  ...
  [ ] r1_order=7 & r1_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r1_time+ r1at2_floor_12Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=8) & (r1_time'= r1_time+ r1at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=8) & (r1_time'= r1_time+ r1at2_floor_12Time + 0) & (at2_floor_12'=1);
