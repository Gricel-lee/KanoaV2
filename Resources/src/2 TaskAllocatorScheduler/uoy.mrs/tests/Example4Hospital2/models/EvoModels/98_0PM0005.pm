...
module r1
  ...
  [ ] r1_order=7 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & r1_time>=r2_time & (r1_time+ r1at2_floor_9Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=8) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=8) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1);
