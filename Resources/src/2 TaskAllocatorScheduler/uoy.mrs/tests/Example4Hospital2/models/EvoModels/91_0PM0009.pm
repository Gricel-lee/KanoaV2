...
const int r2_travDist = 12; //l8->room2->room3->room5->room5->room2
...
module r2
  ...
  [ ] r2_order=4 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & r2_time>=r1_time & (r2_time+ r2at2_floor_12Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1);
  [ ] r2_order=5 & r2_fail=0 & at4_notify_2=1 & r2_time>=r1_time & (r2_time+ r2at3_sanit_4Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1);
