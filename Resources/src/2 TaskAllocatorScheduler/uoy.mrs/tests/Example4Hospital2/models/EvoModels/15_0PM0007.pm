...
module r1
  ...
  [ ] r1_order=4 & r1_fail=0 & at4_notify_5=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_7Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1);
  ...
  [ ] r1_order=6 & r1_fail=0 & at4_notify_8=1 & r1_time>=r3_time & (r1_time+ r1at3_sanit_10Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1);
