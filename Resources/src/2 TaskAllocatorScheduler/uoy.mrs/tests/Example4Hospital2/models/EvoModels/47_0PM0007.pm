...
formula done = (r5_order=6 & r4_order=6 & r1_order=7 & r2_order=5);
...
const int r2_travDist = 10; //l8->room2->room2->room3->room2
...
module r1
  ...
  [ ] r1_order=3 & r1_fail=0 & at4_notify_8=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
...
module r2
  ...
  [ ] r2_order=2 & r2_fail=0 & (r2_time+ r2at4_notify_2Time + 0 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_2Time + 0) & (at4_notify_2'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_2Time + 0) & (at4_notify_2'=1);
  ...
  [ ] r2_order=4 & r2_fail=0 & at4_notify_2=1 & (r2_time+ r2at3_sanit_4Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1);
