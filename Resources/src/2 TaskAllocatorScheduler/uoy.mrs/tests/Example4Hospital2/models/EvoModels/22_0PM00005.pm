...
formula done = (r5_order=6 & r4_order=4 & r3_order=3 & r1_order=7 & r2_order=5);

// failure
formula fail = (r5_fail=0 & r4_fail=0 & r3_fail=0 & r1_fail=0 & r2_fail=0 );
...
const int r4_travDist = 10; //l10->room1->room5
const int r3_travDist = 3; //l9->room6
const int r1_travDist = 10; //l7->room2->room3->room3->room3->room4->room4
const int r2_travDist = 10; //l8->room2->room5->room5->room2
...
module r1
  ...
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r1_time+ r1at2_floor_6Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_6Time + 0) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_6Time + 0) & (at2_floor_6'=1);
  [ ] r1_order=4 & r1_fail=0 & at4_notify_5=1 & (r1_time+ r1at3_sanit_7Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  ...
  [ ] r1_order=6 & r1_fail=0 & at4_notify_8=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
...
module r2
  ...
  [ ] r2_order=2 & r2_fail=0 & at4_notify_11=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
  [ ] r2_order=3 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r2_time+ r2at2_floor_12Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1);
  [ ] r2_order=4 & r2_fail=0 & at3_sanit_4=1 & at4_notify_2=1 & r2_time>=r1_time & (r2_time+ r2at2_floor_3Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_3Time + 2) & (at2_floor_3'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_3Time + 2) & (at2_floor_3'=1);
