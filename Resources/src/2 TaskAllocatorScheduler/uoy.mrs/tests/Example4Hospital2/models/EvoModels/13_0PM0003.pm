...
formula done = (r4_order=6 & r3_order=4 & r5_order=4 & r2_order=10);

// failure
formula fail = (r4_fail=0 & r3_fail=0 & r5_fail=0 & r2_fail=0 );
...
const int r3_travDist = 9; //l9->room1->room5
const int r5_travDist = 3; //l11->room6->room2
const int r2_travDist = 14; //l8->room2->room2->room3->room3->room3->room4->room5->room5->room4
...
module r3
  ...
  [ ] r3_order=3 & r3_fail=0 & (r3_time+ r3at4_notify_11Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=4) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=4) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1);

  // failure and recovery
  [ ] r3_fail=1 -> (r3_fail'=0); // fail
  [r3idle] r3_order!=4 & r3_fail=0 & (r3_time+1<=TT) -> (r3_time'=r3_time+1); // idle
endmodule
...
module r5
  ...
  [ ] r5_order=3 & r5_fail=0 & (r5_time+ r5at4_notify_2Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=4) & (r5_time'= r5_time+ r5at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=4) & (r5_time'= r5_time+ r5at4_notify_2Time + 2) & (at4_notify_2'=1);
...
module r2
  ...
  //r2_order=4: task at2_floor_6
  //r2_order=5: task at3_sanit_7
  ...
  [ ] r2_order=4 & r2_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r2_time+ r2at2_floor_6Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_6Time + 0) & (at2_floor_6'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_6Time + 0) & (at2_floor_6'=1);
  [ ] r2_order=5 & r2_fail=0 & at4_notify_5=1 & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  [ ] r2_order=6 & r2_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r2_time+ r2at2_floor_9Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=7) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=7) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1);
  ...
  [ ] r2_order=8 & r2_fail=0 & at4_notify_11=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_13Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1);
  [ ] r2_order=9 & r2_fail=0 & at4_notify_8=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_10Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1);
