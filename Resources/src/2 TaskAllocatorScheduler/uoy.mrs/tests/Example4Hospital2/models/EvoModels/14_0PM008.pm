...
formula done = (r5_order=6 & r4_order=5 & r2_order=12);
...
const int r2_travDist = 16; //l8->room2->room2->room2->room3->room3->room3->room4->room4->room5->room4->room5
...
module r2
  ...
  //r2_order=5: task at2_floor_6
  //r2_order=6: task at3_sanit_7
  //r2_order=7: task at4_notify_8
  //r2_order=8: task at3_sanit_10
  //r2_order=9: task at2_floor_12
  //r2_order=10: task at2_floor_9
  //r2_order=11: task at3_sanit_13
  r2_order: [0..12] init 0; // execution order
  ...
  [ ] r2_order=5 & r2_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r2_time+ r2at2_floor_6Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_6Time + 0) & (at2_floor_6'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_6Time + 0) & (at2_floor_6'=1);
  [ ] r2_order=6 & r2_fail=0 & at4_notify_5=1 & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=7) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=7) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  [ ] r2_order=7 & r2_fail=0 & (r2_time+ r2at4_notify_8Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=8) & (r2_time'= r2_time+ r2at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=8) & (r2_time'= r2_time+ r2at4_notify_8Time + 2) & (at4_notify_8'=1);
  [ ] r2_order=8 & r2_fail=0 & at4_notify_8=1 & (r2_time+ r2at3_sanit_10Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_10Time + 0) & (at3_sanit_10'=1);
  ...
  [ ] r2_order=10 & r2_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r2_time+ r2at2_floor_9Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=11) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=11) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1);
  [ ] r2_order=11 & r2_fail=0 & at4_notify_11=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=12) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=12) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);

  // failure and recovery
  [ ] r2_fail=1 -> (r2_fail'=0); // fail
  [r2idle] r2_order!=12 & r2_fail=0 & (r2_time+1<=TT) -> (r2_time'=r2_time+1); // idle
endmodule
