...
module r3
  ...
  [at1_move_1] r3_order=2 & r3_fail=0 & (r3_time+r3at1_move_1Time<=TT) & r3_time=r4_time -> (r3_order'=3) & (r3_time'= r3_time + r3at1_move_1Time);
  ...
  [at1_move_0] r3_order=4 & r3_fail=0 & (r3_time+r3at1_move_0Time<=TT) & r3_time=r4_time -> (r3_order'=5) & (r3_time'= r3_time + r3at1_move_0Time);
