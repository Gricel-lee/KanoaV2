...
module r1
  ...
  [ ] r1_order=3 & r1_fail=0 & at4_notify_8=1 & (r1_time+ r1at3_sanit_10Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1);
