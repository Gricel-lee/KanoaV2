...
const int r1_travDist = 9; //l7->room3->room4->room4->room5->room5->room4
...
module r2
  ...
  [ ] r2_order=4 & r2_fail=0 & (r2_time+ r2at4_notify_11Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=5) & (r2_time'= r2_time+ r2at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at4_notify_11Time + 2) & (at4_notify_11'=1);
...
module r1
  ...
  [ ] r1_order=2 & r1_fail=0 & (r1_time+ r1at4_notify_8Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_8Time + 2) & (at4_notify_8'=1);
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r1_time+ r1at2_floor_9Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 0) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 0) & (at2_floor_9'=1);
  ...
  [ ] r1_order=5 & r1_fail=0 & at4_notify_11=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_13Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1);
  [ ] r1_order=6 & r1_fail=0 & at4_notify_8=1 & (r1_time+ r1at3_sanit_10Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1);
