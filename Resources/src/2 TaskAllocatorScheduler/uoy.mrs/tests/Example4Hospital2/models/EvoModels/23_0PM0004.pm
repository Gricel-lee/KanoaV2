...
formula done = (r5_order=5 & r4_order=4 & r3_order=4 & r1_order=8);

// failure
formula fail = (r5_fail=0 & r4_fail=0 & r3_fail=0 & r1_fail=0 );
...
const int r3_travDist = 5; //l9->room6->room3
...
module r1
  ...
  [ ] r1_order=2 & r1_fail=0 & at4_notify_5=1 & r1_time>=r3_time & (r1_time+ r1at3_sanit_7Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1);
