...
formula done = (r5_order=5 & r4_order=4 & r3_order=5 & r2_order=10);

// failure
formula fail = (r5_fail=0 & r4_fail=0 & r3_fail=0 & r2_fail=0 );
...
const int r4_travDist = 10; //l10->room1->room2
const int r3_travDist = 7; //l9->room6->room3->room4
const int r2_travDist = 14; //l8->room2->room2->room3->room3->room4->room5->room5->room5->room4
...
module r4
  ...
  [ ] r4_order=3 & r4_fail=0 & (r4_time+ r4at4_notify_2Time + 2 <=TT) -> (pr4_Succ_at4_notify): (r4_order'=4) & (r4_time'= r4_time+ r4at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr4_Succ_at4_notify): (r4_fail'=1) & (r4_order'=4) & (r4_time'= r4_time+ r4at4_notify_2Time + 2) & (at4_notify_2'=1);
...
module r3
  ...
  //r3_order=3: task at4_notify_5
  //r3_order=4: task at4_notify_8
  ...
  [ ] r3_order=3 & r3_fail=0 & (r3_time+ r3at4_notify_5Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=4) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=4) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1);
  [ ] r3_order=4 & r3_fail=0 & (r3_time+ r3at4_notify_8Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=5) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=5) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1);
...
module r2
  ...
  //r2_order=3: task at2_floor_6
  //r2_order=4: task at3_sanit_7
  //r2_order=5: task at2_floor_9
  //r2_order=6: task at4_notify_11
  //r2_order=7: task at2_floor_12
  //r2_order=8: task at3_sanit_13
  //r2_order=9: task at3_sanit_10
  r2_order: [0..10] init 0; // execution order
  ...
  [ ] r2_order=2 & r2_fail=0 & at4_notify_2=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_4Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_4Time + 0) & (at3_sanit_4'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_4Time + 0) & (at3_sanit_4'=1);
  [ ] r2_order=3 & r2_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r2_time+ r2at2_floor_6Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_6Time + 2) & (at2_floor_6'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_6Time + 2) & (at2_floor_6'=1);
  [ ] r2_order=4 & r2_fail=0 & at4_notify_5=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  [ ] r2_order=5 & r2_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r2_time+ r2at2_floor_9Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_9Time + 2) & (at2_floor_9'=1);
  [ ] r2_order=6 & r2_fail=0 & (r2_time+ r2at4_notify_11Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=7) & (r2_time'= r2_time+ r2at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=7) & (r2_time'= r2_time+ r2at4_notify_11Time + 2) & (at4_notify_11'=1);
  [ ] r2_order=7 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r2_time+ r2at2_floor_12Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=8) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=8) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1);
  [ ] r2_order=8 & r2_fail=0 & at4_notify_11=1 & (r2_time+ r2at3_sanit_13Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1);
  [ ] r2_order=9 & r2_fail=0 & at4_notify_8=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_10Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1);

  // failure and recovery
  [ ] r2_fail=1 -> (r2_fail'=0); // fail
  [r2idle] r2_order!=10 & r2_fail=0 & (r2_time+1<=TT) -> (r2_time'=r2_time+1); // idle
endmodule
