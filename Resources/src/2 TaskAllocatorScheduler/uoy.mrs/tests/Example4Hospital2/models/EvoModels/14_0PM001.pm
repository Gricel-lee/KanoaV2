...
const int r2_travDist = 12; //l8->room2->room2->room2->room3->room3->room3->room4->room4->room4->room5->room5
...
module r2
  ...
  //r2_order=10: task at3_sanit_13
  //r2_order=11: task at2_floor_12
  ...
  [ ] r2_order=8 & r2_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r2_time+ r2at2_floor_9Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=9) & (r2_time'= r2_time+ r2at2_floor_9Time + 0) & (at2_floor_9'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at2_floor_9Time + 0) & (at2_floor_9'=1);
  [ ] r2_order=9 & r2_fail=0 & at4_notify_8=1 & (r2_time+ r2at3_sanit_10Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 0) & (at3_sanit_10'=1);
  [ ] r2_order=10 & r2_fail=0 & at4_notify_11=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=11) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=11) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
  [ ] r2_order=11 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r2_time+ r2at2_floor_12Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=12) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=12) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1);
