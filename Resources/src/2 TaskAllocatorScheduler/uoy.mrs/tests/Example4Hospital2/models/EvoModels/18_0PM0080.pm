...
formula done = (r5_order=6 & r4_order=5 & r1_order=11 & r2_order=2);
...
const int r5_travDist = 13; //l11->room1->room6->room2
const int r4_travDist = 10; //l10->room1->room6
const int r1_travDist = 16; //l7->room2->room2->room3->room3->room3->room4->room4->room5->room4->room5
const int r2_travDist = 11; //l8->room5
...
module r5
  ...
  [ ] r5_order=5 & r5_fail=0 & (r5_time+ r5at4_notify_2Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_2Time + 2) & (at4_notify_2'=1);
...
module r1
  ...
  //r1_order=3: task at4_notify_5
  //r1_order=4: task at2_floor_6
  //r1_order=5: task at3_sanit_7
  //r1_order=6: task at4_notify_8
  //r1_order=7: task at3_sanit_10
  //r1_order=8: task at2_floor_12
  //r1_order=9: task at2_floor_9
  //r1_order=10: task at3_sanit_13
  r1_order: [0..11] init 0; // execution order
  ...
  [ ] r1_order=2 & r1_fail=0 & at4_notify_2=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_4Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_4Time + 0) & (at3_sanit_4'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_4Time + 0) & (at3_sanit_4'=1);
  [ ] r1_order=3 & r1_fail=0 & (r1_time+ r1at4_notify_5Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_5Time + 2) & (at4_notify_5'=1);
  [ ] r1_order=4 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r1_time+ r1at2_floor_6Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=5) & (r1_time'= r1_time+ r1at2_floor_6Time + 0) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at2_floor_6Time + 0) & (at2_floor_6'=1);
  [ ] r1_order=5 & r1_fail=0 & at4_notify_5=1 & (r1_time+ r1at3_sanit_7Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  [ ] r1_order=6 & r1_fail=0 & (r1_time+ r1at4_notify_8Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=7) & (r1_time'= r1_time+ r1at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at4_notify_8Time + 2) & (at4_notify_8'=1);
  [ ] r1_order=7 & r1_fail=0 & at4_notify_8=1 & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
  [ ] r1_order=8 & r1_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r1_time+ r1at2_floor_12Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=9) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=9) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1);
  [ ] r1_order=9 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r1_time+ r1at2_floor_9Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=10) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=10) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1);
  [ ] r1_order=10 & r1_fail=0 & at4_notify_11=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_13Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=11) & (r1_time'= r1_time+ r1at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=11) & (r1_time'= r1_time+ r1at3_sanit_13Time + 2) & (at3_sanit_13'=1);

  // failure and recovery
  [ ] r1_fail=1 -> (r1_fail'=0); // fail
  [r1idle] r1_order!=11 & r1_fail=0 & (r1_time+1<=TT) -> (r1_time'=r1_time+1); // idle
endmodule
...
module r2
  ...
  //r2_order=1: task at4_notify_11
  r2_order: [0..2] init 0; // execution order
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & (r2_time+ r2at4_notify_11Time + 11 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=2) & (r2_time'= r2_time+ r2at4_notify_11Time + 11) & (at4_notify_11'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at4_notify_11Time + 11) & (at4_notify_11'=1);

  // failure and recovery
  [ ] r2_fail=1 -> (r2_fail'=0); // fail
  [r2idle] r2_order!=2 & r2_fail=0 & (r2_time+1<=TT) -> (r2_time'=r2_time+1); // idle
endmodule
