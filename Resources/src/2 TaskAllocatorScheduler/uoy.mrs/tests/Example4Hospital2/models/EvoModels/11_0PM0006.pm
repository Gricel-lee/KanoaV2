...
module r2
  ...
  [ ] r2_order=8 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r2_time+ r2at2_floor_12Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=9) & (r2_time'= r2_time+ r2at2_floor_12Time + 2) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at2_floor_12Time + 2) & (at2_floor_12'=1);
  [ ] r2_order=9 & r2_fail=0 & at4_notify_11=1 & (r2_time+ r2at3_sanit_13Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1);
