...
module r4
  ...
  [at1_move_1] r4_order=2 & r4_fail=0 & (r4_time+r4at1_move_1Time<=TT) & r4_time=r5_time -> (r4_order'=3) & (r4_time'= r4_time + r4at1_move_1Time);
  ...
  [at1_move_0] r4_order=4 & r4_fail=0 & (r4_time+r4at1_move_0Time<=TT) & r4_time=r5_time -> (r4_order'=5) & (r4_time'= r4_time + r4at1_move_0Time);
