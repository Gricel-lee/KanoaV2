...
const int r5_travDist = 13; //l11->room1->room6->room4
const int r4_travDist = 12; //l10->room1->room6->room3
...
module r5
  ...
  [ ] r5_order=5 & r5_fail=0 & (r5_time+ r5at4_notify_8Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_8Time + 2) & (at4_notify_8'=1);
...
module r4
  ...
  [ ] r4_order=5 & r4_fail=0 & (r4_time+ r4at4_notify_5Time + 2 <=TT) -> (pr4_Succ_at4_notify): (r4_order'=6) & (r4_time'= r4_time+ r4at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr4_Succ_at4_notify): (r4_fail'=1) & (r4_order'=6) & (r4_time'= r4_time+ r4at4_notify_5Time + 2) & (at4_notify_5'=1);
...
module r1
  ...
  [ ] r1_order=4 & r1_fail=0 & at4_notify_8=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
...
module r2
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & at4_notify_5=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_7Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1);
