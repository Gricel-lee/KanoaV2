...
const int r2_travDist = 8; //l8->room2->room2->room2->room3
...
module r2
  ...
  [ ] r2_order=3 & r2_fail=0 & at3_sanit_4=1 & at4_notify_2=1 & (r2_time+ r2at2_floor_3Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_3Time + 0) & (at2_floor_3'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_3Time + 0) & (at2_floor_3'=1);
  [ ] r2_order=4 & r2_fail=0 & at4_notify_5=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_7Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1);
