...
formula done = (r5_order=5 & r4_order=8 & r2_order=10);
...
const int r4_travDist = 16; //l10->room1->room6->room3->room4->room5
...
module r4
  ...
  //r4_order=6: task at4_notify_8
  //r4_order=7: task at4_notify_11
  r4_order: [0..8] init 0; // execution order
  ...
  [ ] r4_order=6 & r4_fail=0 & (r4_time+ r4at4_notify_8Time + 2 <=TT) -> (pr4_Succ_at4_notify): (r4_order'=7) & (r4_time'= r4_time+ r4at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr4_Succ_at4_notify): (r4_fail'=1) & (r4_order'=7) & (r4_time'= r4_time+ r4at4_notify_8Time + 2) & (at4_notify_8'=1);
  [ ] r4_order=7 & r4_fail=0 & (r4_time+ r4at4_notify_11Time + 2 <=TT) -> (pr4_Succ_at4_notify): (r4_order'=8) & (r4_time'= r4_time+ r4at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr4_Succ_at4_notify): (r4_fail'=1) & (r4_order'=8) & (r4_time'= r4_time+ r4at4_notify_11Time + 2) & (at4_notify_11'=1);

  // failure and recovery
  [ ] r4_fail=1 -> (r4_fail'=0); // fail
  [r4idle] r4_order!=8 & r4_fail=0 & (r4_time+1<=TT) -> (r4_time'=r4_time+1); // idle
endmodule
...
module r2
  ...
  [ ] r2_order=7 & r2_fail=0 & at4_notify_11=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=8) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=8) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
