...
const int r2_travDist = 12; //l8->room2->room2->room3->room4->room3
...
module r2
  ...
  [ ] r2_order=5 & r2_fail=0 & (r2_time+ r2at4_notify_5Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=6) & (r2_time'= r2_time+ r2at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at4_notify_5Time + 2) & (at4_notify_5'=1);
