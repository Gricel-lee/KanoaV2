...
public class Kanoa {
	...
	public static void main( String[] args )  throws Exception{
		...
		String fileTest = "TestDummyRefactor_timeconst/config.properties"; //"TestCase3-var4/config.properties"); //Constants.setProperties("TestAlloyPreallocatedTasks/HospitalPreallocatedTasks1/config.properties");
