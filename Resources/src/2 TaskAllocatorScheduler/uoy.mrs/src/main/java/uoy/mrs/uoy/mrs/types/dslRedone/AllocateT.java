 ...
 * </ul>
 *
 * @see uoy.mrs.uoy.mrs.types.dsl.DslPackage#getAllocateT()
 * @model
 * @generated
 */
public interface AllocateT extends Constraints {
	 ...
	 * @see uoy.mrs.uoy.mrs.types.dsl.DslPackage#getAllocateT_At()
	 * @model
	 * @generated
	 */
	AtomicTask getAt();
	 ...
	 * @see uoy.mrs.uoy.mrs.types.dsl.DslPackage#getAllocateT_Ct()
	 * @model
	 * @generated
	 */
	CompoundTask getCt();
	 ...
	 * @see uoy.mrs.uoy.mrs.types.dsl.DslPackage#getAllocateT_Mt()
	 * @model
	 * @generated
	 */
	MissionTask getMt();
	 ...
	 * @see #setRobot(Robot)
	 * @see uoy.mrs.uoy.mrs.types.dsl.DslPackage#getAllocateT_Robot()
	 * @model required="true"
	 * @generated
	 */
	Robot getRobot();
