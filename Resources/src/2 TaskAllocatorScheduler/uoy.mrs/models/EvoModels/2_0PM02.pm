...
module r1
  ...
  [ ] r1_order=5 & r1_fail=0 & at4_notify_3=1 & (r1_time+ r1at3_sanit_5Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_5Time + 0) & (at3_sanit_5'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at3_sanit_5Time + 0) & (at3_sanit_5'=1);
