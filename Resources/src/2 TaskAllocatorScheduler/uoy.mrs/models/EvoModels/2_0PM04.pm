...
const int r1_travDist = 10; //l1->room3->room3->room5->room5->room5
...
module r1
  ...
  [ ] r1_order=3 & r1_fail=0 & at4_notify_3=1 & (r1_time+ r1at3_sanit_5Time + 7 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_5Time + 7) & (at3_sanit_5'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at3_sanit_5Time + 7) & (at3_sanit_5'=1);
  [ ] r1_order=4 & r1_fail=0 & (r1_time+ r1at4_notify_3Time + 0 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=5) & (r1_time'= r1_time+ r1at4_notify_3Time + 0) & (at4_notify_3'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at4_notify_3Time + 0) & (at4_notify_3'=1);
