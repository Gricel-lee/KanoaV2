...
{disj[capability ,  Capability-r3at2_floor-r3at3_sanit-r3at4_notify]}
fact{#r3<=1}
sig r4 extends Robot{}
{disj[capability ,  Capability-r4at2_floor-r4at3_sanit-r4at4_notify]}
fact{#r4<=1}
sig r5 extends Robot{}
{disj[capability ,  Capability-r5at2_floor-r5at3_sanit-r5at4_notify]}
fact{#r5<=1}
...
{all d:do | d in at1_move}
sig r3at2_floor extends Capability{}
{all d:do | d in at2_floor}
sig r3at3_sanit extends Capability{}
{all d:do | d in at3_sanit}
sig r3at4_notify extends Capability{}
{all d:do | d in at4_notify}
sig r4at2_floor extends Capability{}
{all d:do | d in at2_floor}
sig r4at3_sanit extends Capability{}
{all d:do | d in at3_sanit}
sig r4at4_notify extends Capability{}
{all d:do | d in at4_notify}
sig r5at2_floor extends Capability{}
{all d:do | d in at2_floor}
sig r5at3_sanit extends Capability{}
{all d:do | d in at3_sanit}
...
abstract sig at4_notify,at1_move,at2_floor,at3_sanit extends AtomicTask {}
