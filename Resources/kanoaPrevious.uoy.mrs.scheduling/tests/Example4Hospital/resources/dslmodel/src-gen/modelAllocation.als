...
abstract sig at3_sanit,at2_floor,at1_move,at4_notify extends AtomicTask {}
...
fact{no r:r5 | r.capability.do.x<=8} // x constraint
fact{no r:r5 | r.capability.do.y<=5} // y constraint
