...
formula done = (r5_order=7 & r4_order=6 & r2_order=10);

// failure
formula fail = (r5_fail=0 & r4_fail=0 & r2_fail=0 );
...
const int r5_travDist = 15; //l11->room1->room6->room3->room4
...
module r5
  ...
  [ ] r5_order=6 & r5_fail=0 & (r5_time+ r5at4_notify_8Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=7) & (r5_time'= r5_time+ r5at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=7) & (r5_time'= r5_time+ r5at4_notify_8Time + 2) & (at4_notify_8'=1);

  // failure and recovery
  [ ] r5_fail=1 -> (r5_fail'=0); // fail
  [r5idle] r5_order!=7 & r5_fail=0 & (r5_time+1<=TT) -> (r5_time'=r5_time+1); // idle
endmodule
...
module r2
  ...
  [ ] r2_order=4 & r2_fail=0 & at4_notify_5=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  ...
  [ ] r2_order=9 & r2_fail=0 & at4_notify_8=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_10Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=10) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1);
