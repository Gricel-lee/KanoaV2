...
const int r5_travDist = 13; //l11->room1->room6->room3
const int r4_travDist = 12; //l10->room1->room6->room4
const int r1_travDist = 12; //l7->room2->room3->room4->room4->room5->room5->room5
const int r2_travDist = 4; //l8->room3->room2->room2
...
module r5
  ...
  [ ] r5_order=5 & r5_fail=0 & (r5_time+ r5at4_notify_5Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=6) & (r5_time'= r5_time+ r5at4_notify_5Time + 2) & (at4_notify_5'=1);
...
module r4
  ...
  [ ] r4_order=5 & r4_fail=0 & (r4_time+ r4at4_notify_8Time + 2 <=TT) -> (pr4_Succ_at4_notify): (r4_order'=6) & (r4_time'= r4_time+ r4at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr4_Succ_at4_notify): (r4_fail'=1) & (r4_order'=6) & (r4_time'= r4_time+ r4at4_notify_8Time + 2) & (at4_notify_8'=1);
...
module r1
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & at4_notify_2=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_4Time + 6 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1);
  ...
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r1_time+ r1at2_floor_9Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1);
  [ ] r1_order=4 & r1_fail=0 & at4_notify_8=1 & r1_time>=r4_time & (r1_time+ r1at3_sanit_10Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 0) & (at3_sanit_10'=1);
  [ ] r1_order=5 & r1_fail=0 & (r1_time+ r1at4_notify_11Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=6) & (r1_time'= r1_time+ r1at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at4_notify_11Time + 2) & (at4_notify_11'=1);
  [ ] r1_order=6 & r1_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r1_time+ r1at2_floor_12Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=7) & (r1_time'= r1_time+ r1at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at2_floor_12Time + 0) & (at2_floor_12'=1);
  [ ] r1_order=7 & r1_fail=0 & at4_notify_11=1 & (r1_time+ r1at3_sanit_13Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1);
...
module r2
  ...
  //r2_order=2: task at4_notify_2
  //r2_order=3: task at2_floor_3
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & at4_notify_5=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_7Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1);
  [ ] r2_order=2 & r2_fail=0 & (r2_time+ r2at4_notify_2Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at4_notify_2Time + 2) & (at4_notify_2'=1);
  [ ] r2_order=3 & r2_fail=0 & at3_sanit_4=1 & at4_notify_2=1 & r2_time>=r1_time & (r2_time+ r2at2_floor_3Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_3Time + 0) & (at2_floor_3'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at2_floor_3Time + 0) & (at2_floor_3'=1);
