...
module r2
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & at4_notify_5=1 & r2_time>=r1_time & (r2_time+ r2at3_sanit_7Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1);
