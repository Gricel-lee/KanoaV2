...
const int r2_travDist = 8; //l8->room3->room4->room2->room5
...
module r2
  ...
  [ ] r2_order=3 & r2_fail=0 & at4_notify_2=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_4Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_4Time + 2) & (at3_sanit_4'=1);
