...
const int r5_travDist = 15; //l11->room1->room6->room4->room5
const int r4_travDist = 12; //l10->room1->room6->room3
const int r2_travDist = 16; //l8->room2->room2->room2->room3->room3->room4->room5->room4->room5
...
module r5
  ...
  [ ] r5_order=6 & r5_fail=0 & (r5_time+ r5at4_notify_11Time + 2 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=7) & (r5_time'= r5_time+ r5at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=7) & (r5_time'= r5_time+ r5at4_notify_11Time + 2) & (at4_notify_11'=1);
...
module r2
  ...
  [ ] r2_order=4 & r2_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r2_time+ r2at2_floor_6Time + 2 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_6Time + 2) & (at2_floor_6'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at2_floor_6Time + 2) & (at2_floor_6'=1);
  [ ] r2_order=5 & r2_fail=0 & at4_notify_5=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_7Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_7Time + 0) & (at3_sanit_7'=1);
  ...
  [ ] r2_order=7 & r2_fail=0 & at4_notify_11=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=8) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=8) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
