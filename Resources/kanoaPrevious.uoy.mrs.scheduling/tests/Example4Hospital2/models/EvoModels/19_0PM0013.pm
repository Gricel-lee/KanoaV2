...
const int r1_travDist = 7; //l7->room3->room3->room4->room4->room5->room5->room5
const int r2_travDist = 10; //l8->room2->room3->room2
...
module r1
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r1_time+ r1at2_floor_6Time + 3 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=2) & (r1_time'= r1_time+ r1at2_floor_6Time + 3) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at2_floor_6Time + 3) & (at2_floor_6'=1);
  [ ] r1_order=2 & r1_fail=0 & at4_notify_5=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_7Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 0) & (at3_sanit_7'=1);
