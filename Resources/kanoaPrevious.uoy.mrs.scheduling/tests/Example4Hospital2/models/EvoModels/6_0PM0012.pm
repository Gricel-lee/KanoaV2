...
module r1
  ...
  [ ] r1_order=2 & r1_fail=0 & (r1_time+ r1at4_notify_5Time + 0 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_5Time + 0) & (at4_notify_5'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_5Time + 0) & (at4_notify_5'=1);
