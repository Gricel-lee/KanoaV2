...
const int r1_travDist = 14; //l7->room5->room3->room3
...
module r1
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & at4_notify_11=1 & r1_time>=r5_time & (r1_time+ r1at3_sanit_13Time + 12 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_13Time + 12) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_13Time + 12) & (at3_sanit_13'=1);
  ...
  [ ] r1_order=3 & r1_fail=0 & (r1_time+ r1at4_notify_5Time + 0 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_5Time + 0) & (at4_notify_5'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_5Time + 0) & (at4_notify_5'=1);
