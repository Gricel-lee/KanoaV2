...
module r2
  ...
  [ ] r2_order=3 & r2_fail=0 & (r2_time+ r2at4_notify_2Time + 2 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=4) & (r2_time'= r2_time+ r2at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at4_notify_2Time + 2) & (at4_notify_2'=1);
