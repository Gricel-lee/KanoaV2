...
const int r5_travDist = 11; //l11->room3->room6
...
module r2
  ...
  [ ] r2_order=5 & r2_fail=0 & at4_notify_11=1 & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
  [ ] r2_order=6 & r2_fail=0 & (r2_time+ r2at4_notify_11Time + 0 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=7) & (r2_time'= r2_time+ r2at4_notify_11Time + 0) & (at4_notify_11'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=7) & (r2_time'= r2_time+ r2at4_notify_11Time + 0) & (at4_notify_11'=1);
...
module r5
  ...
  //r5_order=1: task at4_notify_5
  //r5_order=2: time travel to join task at1_move_1
  //r5_order=3: join task at1_move_1
  ...
  // do sequence of tasks
  [ ] r5_order=1 & r5_fail=0 & (r5_time+ r5at4_notify_5Time + 9 <=TT) -> (pr5_Succ_at4_notify): (r5_order'=2) & (r5_time'= r5_time+ r5at4_notify_5Time + 9) & (at4_notify_5'=1)+ (1-pr5_Succ_at4_notify): (r5_fail'=1) & (r5_order'=2) & (r5_time'= r5_time+ r5at4_notify_5Time + 9) & (at4_notify_5'=1);
  [ ] r5_order=2 & r5_fail=0 & (r5_time+2<=TT) -> (pr5_Succ_at1_move): (r5_order'=3) & (r5_time'= r5_time+2)+ (1-pr5_Succ_at1_move): (r5_fail'=1) & (r5_order'=3) & (r5_time'= r5_time+2); // travel to join task at1_move_1
  [at1_move_1] r5_order=3 & r5_fail=0 & (r5_time+r5at1_move_1Time<=TT) & r5_time=r3_time -> (r5_order'=4) & (r5_time'= r5_time + r5at1_move_1Time);
