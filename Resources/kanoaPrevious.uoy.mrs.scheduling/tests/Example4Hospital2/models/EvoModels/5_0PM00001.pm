...
const int r3_travDist = 7; //l9->room5->room4
...
module r3
  ...
  //r3_order=1: task at4_notify_11
  //r3_order=2: task at4_notify_8
  ...
  // do sequence of tasks
  [ ] r3_order=1 & r3_fail=0 & (r3_time+ r3at4_notify_11Time + 5 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=2) & (r3_time'= r3_time+ r3at4_notify_11Time + 5) & (at4_notify_11'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=2) & (r3_time'= r3_time+ r3at4_notify_11Time + 5) & (at4_notify_11'=1);
  [ ] r3_order=2 & r3_fail=0 & (r3_time+ r3at4_notify_8Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=3) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=3) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1);
