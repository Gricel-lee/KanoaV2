...
formula done = (r5_order=5 & r4_order=6 & r2_order=7 & r1_order=6);
...
const int r2_travDist = 12; //l8->room2->room2->room3->room4->room5->room5
const int r1_travDist = 14; //l7->room2->room3->room4->room3->room4
...
module r2
  ...
  [ ] r2_order=6 & r2_fail=0 & at4_notify_11=1 & r2_time>=r4_time & (r2_time+ r2at3_sanit_13Time + 0 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=7) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=7) & (r2_time'= r2_time+ r2at3_sanit_13Time + 0) & (at3_sanit_13'=1);
...
module r1
  ...
  [ ] r1_order=2 & r1_fail=0 & at4_notify_5=1 & (r1_time+ r1at3_sanit_7Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1);
  ...
  [ ] r1_order=4 & r1_fail=0 & (r1_time+ r1at4_notify_5Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=5) & (r1_time'= r1_time+ r1at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at4_notify_5Time + 2) & (at4_notify_5'=1);
