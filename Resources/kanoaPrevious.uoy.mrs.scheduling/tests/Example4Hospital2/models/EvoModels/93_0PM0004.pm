...
module r1
  ...
  [ ] r1_order=5 & r1_fail=0 & (r1_time+ r1at4_notify_11Time + 0 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=6) & (r1_time'= r1_time+ r1at4_notify_11Time + 0) & (at4_notify_11'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at4_notify_11Time + 0) & (at4_notify_11'=1);
