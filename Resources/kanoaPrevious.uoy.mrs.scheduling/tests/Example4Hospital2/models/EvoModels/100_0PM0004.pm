...
module r2
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & at4_notify_8=1 & r2_time>=r1_time & (r2_time+ r2at3_sanit_10Time + 8 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_10Time + 8) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_10Time + 8) & (at3_sanit_10'=1);
