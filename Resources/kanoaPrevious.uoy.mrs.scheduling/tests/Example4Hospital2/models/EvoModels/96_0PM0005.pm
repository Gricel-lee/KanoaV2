...
const int r2_travDist = 10; //l8->room2->room2->room4->room3->room3
...
module r2
  ...
  [ ] r2_order=3 & r2_fail=0 & at4_notify_8=1 & r2_time>=r5_time & (r2_time+ r2at3_sanit_10Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1);
  ...
  [ ] r2_order=5 & r2_fail=0 & (r2_time+ r2at4_notify_5Time + 0 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=6) & (r2_time'= r2_time+ r2at4_notify_5Time + 0) & (at4_notify_5'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at4_notify_5Time + 0) & (at4_notify_5'=1);
