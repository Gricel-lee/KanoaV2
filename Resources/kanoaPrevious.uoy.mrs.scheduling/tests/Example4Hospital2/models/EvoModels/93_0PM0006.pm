...
const int r1_travDist = 11; //l7->room3->room4->room5->room4->room5->room5
...
module r1
  ...
  [ ] r1_order=3 & r1_fail=0 & (r1_time+ r1at4_notify_11Time + 2 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at4_notify_11Time + 2) & (at4_notify_11'=1);
  [ ] r1_order=4 & r1_fail=0 & at4_notify_8=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_10Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_10Time + 2) & (at3_sanit_10'=1);
  [ ] r1_order=5 & r1_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & (r1_time+ r1at2_floor_12Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=6) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=6) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1);
