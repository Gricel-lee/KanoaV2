...
const int r1_travDist = 14; //l7->room2->room2->room2->room3->room4->room3->room4
...
module r3
  ...
  [ ] r3_order=5 & r3_fail=0 & (r3_time+ r3at4_notify_5Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=6) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=6) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1);
...
module r1
  ...
  [ ] r1_order=4 & r1_fail=0 & at4_notify_5=1 & r1_time>=r3_time & (r1_time+ r1at3_sanit_7Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at3_sanit_7Time + 2) & (at3_sanit_7'=1);
  ...
  [ ] r1_order=6 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & (r1_time+ r1at2_floor_6Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=7) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=7) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1);
