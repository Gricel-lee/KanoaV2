...
module r2
  ...
  [ ] r2_order=8 & r2_fail=0 & (r2_time+ r2at4_notify_11Time + 0 <=TT) -> (pr2_Succ_at4_notify): (r2_order'=9) & (r2_time'= r2_time+ r2at4_notify_11Time + 0) & (at4_notify_11'=1)+ (1-pr2_Succ_at4_notify): (r2_fail'=1) & (r2_order'=9) & (r2_time'= r2_time+ r2at4_notify_11Time + 0) & (at4_notify_11'=1);
