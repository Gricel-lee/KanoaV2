...
module r1
  ...
  [ ] r1_order=7 & r1_fail=0 & at4_notify_11=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_13Time + 2 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=8) & (r1_time'= r1_time+ r1at3_sanit_13Time + 2) & (at3_sanit_13'=1);
