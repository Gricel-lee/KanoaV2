...
const int r1_travDist = 12; //l7->room2->room3->room4->room4->room5
const int r2_travDist = 12; //l8->room2->room3->room2->room5->room5
...
module r2
  ...
  [ ] r2_order=5 & r2_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & r2_time>=r1_time & (r2_time+ r2at2_floor_12Time + 0 <=TT) -> (pr2_Succ_at2_floor): (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1)+ (1-pr2_Succ_at2_floor): (r2_fail'=1) & (r2_order'=6) & (r2_time'= r2_time+ r2at2_floor_12Time + 0) & (at2_floor_12'=1);
