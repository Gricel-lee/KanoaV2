...
const int r1_travDist = 14; //l7->room2->room2->room3->room3->room3->room4->room4->room5->room5->room4
...
module r1
  ...
  [ ] r1_order=9 & r1_fail=0 & at4_notify_11=1 & r1_time>=r2_time & (r1_time+ r1at3_sanit_13Time + 0 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=10) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=10) & (r1_time'= r1_time+ r1at3_sanit_13Time + 0) & (at3_sanit_13'=1);
  [ ] r1_order=10 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & (r1_time+ r1at2_floor_9Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=11) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=11) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1);
