...
module r1
  ...
  [ ] r1_order=1 & r1_fail=0 & at4_notify_2=1 & (r1_time+ r1at3_sanit_4Time + 6 <=TT) -> (pr1_Succ_at3_sanit): (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1)+ (1-pr1_Succ_at3_sanit): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at3_sanit_4Time + 6) & (at3_sanit_4'=1);
  [ ] r1_order=2 & r1_fail=0 & (r1_time+ r1at4_notify_2Time + 0 <=TT) -> (pr1_Succ_at4_notify): (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_2Time + 0) & (at4_notify_2'=1)+ (1-pr1_Succ_at4_notify): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at4_notify_2Time + 0) & (at4_notify_2'=1);
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_4=1 & at4_notify_2=1 & (r1_time+ r1at2_floor_3Time + 0 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_3Time + 0) & (at2_floor_3'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_3Time + 0) & (at2_floor_3'=1);
