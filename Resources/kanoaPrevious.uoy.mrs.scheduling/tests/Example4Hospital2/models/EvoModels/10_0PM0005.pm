...
formula done = (r5_order=5 & r3_order=9 & r1_order=5 & r2_order=5);

// failure
formula fail = (r5_fail=0 & r3_fail=0 & r1_fail=0 & r2_fail=0 );
...
const int r3at4_notify_11Time=1;
...
const int r3_travDist = 17; //l9->room1->room6->room2->room3->room4->room5
const int r1_travDist = 12; //l7->room2->room3->room4->room5
const int r2_travDist = 12; //l8->room2->room5->room4->room3
...
module r3
  ...
  //r3_order=5: task at4_notify_2
  //r3_order=6: task at4_notify_5
  //r3_order=7: task at4_notify_8
  //r3_order=8: task at4_notify_11
  r3_order: [0..9] init 0; // execution order
  ...
  [ ] r3_order=5 & r3_fail=0 & (r3_time+ r3at4_notify_2Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=6) & (r3_time'= r3_time+ r3at4_notify_2Time + 2) & (at4_notify_2'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=6) & (r3_time'= r3_time+ r3at4_notify_2Time + 2) & (at4_notify_2'=1);
  [ ] r3_order=6 & r3_fail=0 & (r3_time+ r3at4_notify_5Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=7) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=7) & (r3_time'= r3_time+ r3at4_notify_5Time + 2) & (at4_notify_5'=1);
  [ ] r3_order=7 & r3_fail=0 & (r3_time+ r3at4_notify_8Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=8) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=8) & (r3_time'= r3_time+ r3at4_notify_8Time + 2) & (at4_notify_8'=1);
  [ ] r3_order=8 & r3_fail=0 & (r3_time+ r3at4_notify_11Time + 2 <=TT) -> (pr3_Succ_at4_notify): (r3_order'=9) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1)+ (1-pr3_Succ_at4_notify): (r3_fail'=1) & (r3_order'=9) & (r3_time'= r3_time+ r3at4_notify_11Time + 2) & (at4_notify_11'=1);

  // failure and recovery
  [ ] r3_fail=1 -> (r3_fail'=0); // fail
  [r3idle] r3_order!=9 & r3_fail=0 & (r3_time+1<=TT) -> (r3_time'=r3_time+1); // idle
endmodule
...
module r1
  ...
  //r1_order=3: task at2_floor_9
  //r1_order=4: task at2_floor_12
  ...
  // do sequence of tasks
  [ ] r1_order=1 & r1_fail=0 & at3_sanit_4=1 & at4_notify_2=1 & r1_time>=r2_time & (r1_time+ r1at2_floor_3Time + 6 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=2) & (r1_time'= r1_time+ r1at2_floor_3Time + 6) & (at2_floor_3'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=2) & (r1_time'= r1_time+ r1at2_floor_3Time + 6) & (at2_floor_3'=1);
  [ ] r1_order=2 & r1_fail=0 & at3_sanit_7=1 & at4_notify_5=1 & r1_time>=r2_time & (r1_time+ r1at2_floor_6Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=3) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=3) & (r1_time'= r1_time+ r1at2_floor_6Time + 2) & (at2_floor_6'=1);
  [ ] r1_order=3 & r1_fail=0 & at3_sanit_10=1 & at4_notify_8=1 & r1_time>=r2_time & (r1_time+ r1at2_floor_9Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=4) & (r1_time'= r1_time+ r1at2_floor_9Time + 2) & (at2_floor_9'=1);
  [ ] r1_order=4 & r1_fail=0 & at3_sanit_13=1 & at4_notify_11=1 & r1_time>=r2_time & (r1_time+ r1at2_floor_12Time + 2 <=TT) -> (pr1_Succ_at2_floor): (r1_order'=5) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1)+ (1-pr1_Succ_at2_floor): (r1_fail'=1) & (r1_order'=5) & (r1_time'= r1_time+ r1at2_floor_12Time + 2) & (at2_floor_12'=1);
...
module r2
  ...
  //r2_order=1: task at3_sanit_4
  //r2_order=2: task at3_sanit_13
  //r2_order=3: task at3_sanit_10
  //r2_order=4: task at3_sanit_7
  ...
  // do sequence of tasks
  [ ] r2_order=1 & r2_fail=0 & at4_notify_2=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_4Time + 6 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_4Time + 6) & (at3_sanit_4'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=2) & (r2_time'= r2_time+ r2at3_sanit_4Time + 6) & (at3_sanit_4'=1);
  [ ] r2_order=2 & r2_fail=0 & at4_notify_11=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_13Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=3) & (r2_time'= r2_time+ r2at3_sanit_13Time + 2) & (at3_sanit_13'=1);
  [ ] r2_order=3 & r2_fail=0 & at4_notify_8=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_10Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=4) & (r2_time'= r2_time+ r2at3_sanit_10Time + 2) & (at3_sanit_10'=1);
  [ ] r2_order=4 & r2_fail=0 & at4_notify_5=1 & r2_time>=r3_time & (r2_time+ r2at3_sanit_7Time + 2 <=TT) -> (pr2_Succ_at3_sanit): (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1)+ (1-pr2_Succ_at3_sanit): (r2_fail'=1) & (r2_order'=5) & (r2_time'= r2_time+ r2at3_sanit_7Time + 2) & (at3_sanit_7'=1);
