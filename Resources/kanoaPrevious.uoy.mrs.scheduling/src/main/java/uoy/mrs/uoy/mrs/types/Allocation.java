...
public class Allocation {
	...
	public List<RobotDepricated> robots = new ArrayList<RobotDepricated>();
	...
	/**constructor*/
	public Allocation(String allocFile) {
		file = allocFile;
	}
	...
	public void getRobotList(String sInit) {
		...
		for (String rt : robots_n_tasks) { //e.g. 1:['at1_move_0', 'at1_move_1']
			...
			String tasks = list[1];
			// create robot
			RobotDepricated r = new RobotDepricated(robotID,tasks);
	...
	public void setBounds() {
		for (int i=0 ; i<getNumRobots() ; i++) {
			RobotDepricated r = robots.get(i);  	   // get ith robot	
