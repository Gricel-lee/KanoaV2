...
public class RunApp {
	...
	public static void main( String[] args )  throws Exception{
		...
		// set config.properties //mrs.setPropertiesFile(args);
		if(args.length>0) {Constants.setProperties(args[0]);}
		else {Constants.setProperties("TestDummyRefactor/config.properties");}//"TestCase3-var4/config.properties"); //Constants.setProperties("TestAlloyPreallocatedTasks/HospitalPreallocatedTasks1/config.properties");
	...
	/*Run*/
	public void runKanoa() throws Exception {
		System.out.println(System.getProperty("user.dir"));
		
		//------- Load DSL info
		ProblemSpecification.initialise();
		//------- Timer
	...
	public void runAllocator(){
    	...
    	ProblemSpecification.setalloyFilesOutput(RunAlloy.runAlloy(Constants.genAlloyModel,Constants.num_instances));
	...
	private void runPreTaskScheduler() {
		...
		// -- Alloy .xml files
//		List<String> alloyAllocationsFiles =  self.alloyAllocDir + "/Allocation*.xml" # Alloy allocation outputs
//	       
//		getFilesWithPrefix(
