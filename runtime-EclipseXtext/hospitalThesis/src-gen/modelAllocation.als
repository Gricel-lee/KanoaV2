...
abstract sig at1,at4,at3,at2 extends AtomicTask {}
...
// ----------------CONSTRAINTS:
 ...
 fact {all at: at2_11| one d: do.at | d in r3.capability}
 fact {all at: at3_13| one d: do.at | d in r3.capability}
 fact {all at: at2_14| one d: do.at | d in r3.capability}
 fact {all at: at4_6| one d: do.at | d in r2.capability}
 fact {all at: at3_7| one d: do.at | d in r2.capability}
 fact {all at: at2_8| one d: do.at | d in r2.capability}
 fact {all at: at4_9| one d: do.at | d in r3.capability}
 fact {all at: at4_3| one d: do.at | d in r3.capability}
 fact {all at: at3_4| one d: do.at | d in r3.capability}
 fact {all at: at2_5| one d: do.at | d in r3.capability}
 fact {all at: at1_1| one d: do.at | d in r4.capability}
 fact {all at: at1_2| one d: do.at | d in r5.capability}
 fact {all at: at4_12| one d: do.at | d in r3.capability}
 fact {all at: at3_10| one d: do.at | d in r3.capability}
