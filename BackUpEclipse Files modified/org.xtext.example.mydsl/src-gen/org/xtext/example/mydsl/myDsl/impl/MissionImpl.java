 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MissionImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MissionImpl extends MinimalEObjectImpl.Container implements Mission
{
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MISSION__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.MISSION__NAME:
        return getName();
      case MyDslPackage.MISSION__DESCRIPTION:
