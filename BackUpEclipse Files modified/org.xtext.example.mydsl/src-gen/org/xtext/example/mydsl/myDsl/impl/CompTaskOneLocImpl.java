...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Comp Task One Loc</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CompTaskOneLocImpl#getCt <em>Ct</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CompTaskOneLocImpl#getLoc <em>Loc</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.CompTaskOneLocImpl#getCriticality <em>Criticality</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompTaskOneLocImpl extends MissionImpl implements CompTaskOneLoc
{
  /**
  ...
  {
    return MyDslPackage.Literals.COMP_TASK_ONE_LOC;
  }
    ...
    if (ct != null && ct.eIsProxy())
    {
      ...
      if (ct != oldCt)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.COMP_TASK_ONE_LOC__CT, oldCt, ct));
      }
    }
    return ct;
  }
  ...
  public void setCt(CompoundTask newCt)
  {
    ...
    ct = newCt;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.COMP_TASK_ONE_LOC__CT, oldCt, ct));
  }
  ...
  public Location getLoc()
  {
    if (loc != null && loc.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.COMP_TASK_ONE_LOC__LOC, oldLoc, loc));
      }
    }
    return loc;
  }
  ...
  public void setLoc(Location newLoc)
  {
    ...
    loc = newLoc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.COMP_TASK_ONE_LOC__LOC, oldLoc, loc));
  }
  ...
  public void setCriticality(String newCriticality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.COMP_TASK_ONE_LOC__CRITICALITY, oldCriticality, criticality));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.COMP_TASK_ONE_LOC__CT:
        if (resolve) return getCt();
        return basicGetCt();
      case MyDslPackage.COMP_TASK_ONE_LOC__LOC:
        if (resolve) return getLoc();
        return basicGetLoc();
      case MyDslPackage.COMP_TASK_ONE_LOC__CRITICALITY:
